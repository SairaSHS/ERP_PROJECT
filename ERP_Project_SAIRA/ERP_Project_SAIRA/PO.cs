...
namespace ERP_Project_SAIRA
{
    public partial class PO : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand cmd1 = new OleDbCommand("select POID from PO where Approve='Not Approved';", mc.conn);
          ...
          MessageBox.Show("successfilly");
          cmd.ExecuteNonQuery();
                mc.conn.Close();
                if (textBox5.Text != "")
                {
                    string tempStr = (textBox6.Text.Length > 3) ? textBox6.Text.Substring(0, 3) : textBox6.Text.Substring(0, 2);
                    this.textBox10.Text = tempStr + "_" + counter + "_" + DateTime.Now.Year.ToString();
                }
                else
                {
                    this.textBox10.Text = textBox2.Text + "_" + this.comboBox4.Text + "_" + counter;
                }
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                myconnection mc = new myconnection();
                mc.conn.Open();
                OleDbCommand cmd2 = new OleDbCommand("select * from Products where PModel='" + this.comboBox3.Text + "';", mc.conn);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                myconnection mc = new myconnection();
                mc.conn.Open();
                OleDbCommand cmd = new OleDbCommand("update PO SET Approve = '" + this.comboBox5.Text + "' where POID='" + this.comboBox4.Text + "';", mc.conn);
                cmd.ExecuteReader();
